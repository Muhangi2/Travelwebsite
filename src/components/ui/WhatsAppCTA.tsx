...
export default function WhatsAppCTA({ className = '' }: { className?: string }) {
  return (
    <a
      ...
      className={`inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-6 py-3 text-xs font-medium tracking-[0.18em] text-white shadow-md transition hover:bg-[#1ebe5a] hover:shadow-lg sm:px-8 ${className}`}
    >
