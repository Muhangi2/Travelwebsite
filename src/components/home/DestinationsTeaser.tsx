          ...
          <Reveal variant="left">
            <div className="lg:pr-8">
              ...
              <div className="mt-12 flex items-center gap-5 border-l border-neutral-300 pl-8">
                ...
                <NavLink
                  to="/destinations"
                  className="text-xs font-semibold tracking-[0.28em] text-black hover:underline"
                >
                ...
                {visible.map((it, i) => (
                  ...
                  >
                    <img
                      ...
                      alt={it.country}
                      loading="lazy"
                      className="h-full w-full object-cover transition duration-[1500ms] ease-out group-hover:scale-110 motion-safe:animate-[fadeIn_900ms_ease-out]"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-transparent" />
                    <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6 md:p-7">
                      <p className="font-serif text-base leading-tight text-white drop-shadow-md sm:text-xl md:text-2xl lg:text-3xl">
                        {it.country}
                      </p>
                    </div>
                  </NavLink>
