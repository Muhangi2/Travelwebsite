...
const reviews: Review[] = [
  {
    ...
    body: '"Still Wild Safaris exceeded every expectation. Our guide was not just a driver but a fountain of knowledge. The attention to detail in our luxury lodge selections made the trip truly special."',
  },
  {
    date: '31/01/2026',
    name: 'Sarah Mitchell',
    body: '"Our safari with Still Wild Safaris was beyond anything we imagined. The guides were incredibly knowledgeable, the lodges were beautiful, and gorilla trekking was a life-changing experience."',
  },
  {
    date: '31/01/2026',
    name: 'Daniel Roberts',
  ...
  return (
    <section className="section-alt py-20">
      <div className="mx-auto max-w-7xl px-6">
        <Reveal>
          <h2 className="text-center">Our Guests Reviews</h2>
        </Reveal>

        <Stagger className="cards-scroll-3 mt-10 gap-6" staggerMs={100}>
          {reviews.map((r) => (
            <article key={r.name} className="card-lift rounded-md bg-white p-6 shadow-sm ring-1 ring-neutral-100">
